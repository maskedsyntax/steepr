...
#ifndef STEEPRWATCH_SWIFT_H
#define STEEPRWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SteeprWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11SteeprWatch14WatchDataStore")
@interface WatchDataStore : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface WatchDataStore (SWIFT_EXTENSION(SteeprWatch)) <WCSessionDelegate>

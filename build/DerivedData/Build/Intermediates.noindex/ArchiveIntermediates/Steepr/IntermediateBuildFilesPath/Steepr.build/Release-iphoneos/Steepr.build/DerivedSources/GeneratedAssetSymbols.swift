...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let steeprLogo = DeveloperToolsSupport.ImageResource(name: "SteeprLogo", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "SteeprLogo" asset catalog image.
    static var steeprLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .steeprLogo)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "SteeprLogo" asset catalog image.
    static var steeprLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .steeprLogo)
#else
        .init()
